        ...
        if (userEmail.length == 0 && userPass.length == 0) {
            Alert.alert(
                ...
                return (
                    ...
                    <TextInput placeholder="Email" style={style.entryStyle} onChangeText = {text => setUserEmail(text)}/>
                    </View>
                    
                    <View style={style.emailViewStyle}>
                    <Image source={require('../Images/ic_password.png')} style={style.leftEmailPassIconStyle} />
                    <TextInput placeholder="Password" style={style.entryStyle} secureTextEntry={true} onChangeText = {text => setUserPass(text)}/>
                    </View>
